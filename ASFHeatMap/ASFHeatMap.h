...
//! Project version number for ASFHeatMap.
FOUNDATION_EXPORT double ASFHeatMapVersionNumber;

//! Project version string for ASFHeatMap.
FOUNDATION_EXPORT const unsigned char ASFHeatMapVersionString[];
